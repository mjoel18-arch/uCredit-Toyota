...
export function CustomersView({ productName, customerName, onUnauthorized }: { productName: string; customerName: string; onUnauthorized: () => void }) {
  ...
  return <section className="hero-card customer-search" aria-labelledby="customers-title">
    ...
    <p>Consulta clientes sin crear ni modificar información Legacy.</p>
